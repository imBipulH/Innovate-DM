      ...
      <div className='container lg:py-20 my-10 relative'>
        ...
        <div className='flex flex-col justify-center items-center lg:flex-row lg:items-end'>
          <div className='text-center lg:text-left w-full lg:w-2/3'>
            ...
            <button className='px-8 py-3 my-8 bg-primary text-white text-xl font-sans font-bold  rounded-full'>
              Get Free Quoto
            </button>
          </div>

          {/* Banner Part Two (Images & Icons) */}
