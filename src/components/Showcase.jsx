  ...
  return (
    <div className='container py-2 lg:py-20'>
      ...
      <div className='mt-14 flex flex-wrap lg:flex-nowrap gap-6'>
        <div className='h-[344px] size-full w-full max-w-fit lg:w-1/4 bg-gray rounded-2xl overflow-hidden'>
          <img
            src='https://shorturl.at/mGLe7'
            className='w-full h-full'
          />
        </div>
        <div className='h-[344px] md:w-2/4 bg-gray rounded-2xl overflow-hidden'>
          <img
            src='https://shorturl.at/JuQDl'
            className='w-full h-full object-cover'
          />
        </div>
        <div className='h-[344px] w-fit lg:w-1/4 bg-gray rounded-2xl overflow-hidden'>
          <img
      ...
      <div className='my-6 flex flex-wrap lg:flex-nowrap gap-6'>
        ...
        <div className='h-[432px] lg:w-[29%] bg-gray rounded-2xl overflow-hidden'>
          <img
            src='https://shorturl.at/Nd85l'
            className='w-full h-full object-cover'
          />
        </div>
        <div className='h-[432px] lg:w-[33%] bg-gray rounded-2xl overflow-hidden'>
          <img
